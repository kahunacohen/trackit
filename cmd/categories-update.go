...
var updateCmd = &cobra.Command{
	...
	Short: "updates an existing category. update <id> <name>",
	Long:  `updates an existing category by id. update <id> <name>. Get the category id by doing trackit categories list`, RunE: func(cmd *cobra.Command, args []string) error {
		db, err := getDB()
		if err != nil {
